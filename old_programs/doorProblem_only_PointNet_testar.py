...
def main_program():
    ...
    sum_total_program_time = 0
    array_total_program_time = []

    #calcular desvio padrão também depois.
    #Faço é o desvio padrão da média.
    ...
    #while True:
        ...
        if str(i) == "0" or str(i) == "1":
            ...
            sum_total_program_time = sum_total_program_time + total_program_time
            array_total_program_time.append(total_program_time)


    media = sum_total_program_time / 10
    print("Mean Total Program time: " +str(media))
    print("Devio padrão: " + str(np.std(array_total_program_time)))
    print(array_total_program_time)    
