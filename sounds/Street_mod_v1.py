...
def run_second_mode():
    #exec(open("doorProblem_only_PointNet.py").read())
    #subprocess.run("python3 doorProblem_only_PointNet.py")
    os.system("python3 doorProblem_only_PointNet_v2.py")
...
def main_program():
    ...
    while True:
        ...
        if change_mod == 5:
            ...
            p = multiprocessing.Process(target=run_second_mode)
            p.start()
